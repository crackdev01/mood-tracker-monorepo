...
export class CreateMoodEntity1613776989480 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mood_entity" ("id" SERIAL NOT NULL, "status" "mood_entity_status_enum" NOT NULL DEFAULT 'relaxed', "intensity" "mood_entity_intensity_enum" NOT NULL DEFAULT '0', "enteredAt" character varying NOT NULL, "userUuid" uuid, CONSTRAINT "PK_a3beea07137616eaad9b0940986" PRIMARY KEY ("id"))`);
